...
<p align="center">
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/🇨🇳_中文-1e293b?style=for-the-badge" alt="中文"/></a>
    <a href="README.ja.md"><img src="https://img.shields.io/badge/🇯🇵_日本語-2dd4bf?style=for-the-badge" alt="日本語"/></a>
...
<p align="center">
  <img src="docs/assets/deid-scanner.svg" alt="DICOM 匿名化アニメーション — X線と書類の名前消去" width="520"/>
</p>
...
<p align="center">
  ...
  <a href="https://dacameragirl.github.io/dicom-forge/"><img src="https://img.shields.io/badge/docs-dacameragirl.github.io-2dd4bf.svg" alt="ドキュメント"/></a>
  <img src="https://img.shields.io/badge/license-PolyForm%20Noncommercial%201.0.0-orange.svg" alt="License"/>
</p>

**[3D Slicer](https://www.slicer.org/) と [ITK-SNAP](http://www.itksnap.org/) 向けのエンタープライズ DICOM パイプライン。**

`dicom-forge` は DICOM フォルダを **匿名化**（患者名・ID をヘッダから除去）し、**QC** を実行して NIfTI / NRRD / `.seg.nrrd` に **変換**します。各実行で監査レコードを生成します。

ヘッドレス中核。GUI は [`slicer-forge`](https://github.com/DaCameraGirl/slicer-forge)。

> 📌 **初めて？** [**ショーケース**](SHOWCASE.md) をご覧ください。

---

## なぜ作ったか

本番パイプラインは **テスト可能なコア** と **薄い GUI** を分離します。Slicer なしで CI テスト可能です。

## 機能

- 取り込み、匿名化（3段階）、QC、変換、セグメンテーション、Pydantic、CLI `dicomforge`
