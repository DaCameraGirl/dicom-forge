...
<p align="center">
  <a href="README.zh-CN.md"><img src="https://img.shields.io/badge/🇨🇳_中文-1e293b?style=for-the-badge" alt="中文"/></a>
    ...
    <a href="README.it.md"><img src="https://img.shields.io/badge/🇮🇹_Italiano-2dd4bf?style=for-the-badge" alt="Italiano"/></a>
    <a href="README.ar.md"><img src="https://img.shields.io/badge/🇸🇦_العربية-1e293b?style=for-the-badge" alt="العربية"/></a>
</p>

<p align="center">
  <img src="docs/assets/deid-scanner.svg" alt="De-identificazione DICOM animata — radiografia e nomi oscurati" width="520"/>
</p>
...
<p align="center">
  ...
  <a href="https://dacameragirl.github.io/dicom-forge/"><img src="https://img.shields.io/badge/docs-dacameragirl.github.io-2dd4bf.svg" alt="Documentazione"/></a>
  <img src="https://img.shields.io/badge/license-PolyForm%20Noncommercial%201.0.0-orange.svg" alt="License"/>
</p>

**Pipeline di imaging medico per [3D Slicer](https://www.slicer.org/) e [ITK-SNAP](http://www.itksnap.org/).**

`dicom-forge` prende una cartella DICOM, la **de-identifica** (rimuove nomi e ID paziente), esegue **QC** e **converte** in NIfTI, NRRD e `.seg.nrrd`.

Nucleo headless; [`slicer-forge`](https://github.com/DaCameraGirl/slicer-forge) è la GUI Slicer.

> 📌 **Nuovo?** Leggi lo [**showcase**](SHOWCASE.md).

---

## Perché esiste

Separa **core testabile** e **GUI sottile**. Testabile in CI senza Slicer.

## Funzionalità

- Ingestione, de-id (3 livelli), QC, conversione, segmentazione, Pydantic, CLI `dicomforge`
...
De-id **prima** della conversione, **in memoria**.

> ⚠️ **Riduzione del rischio, non garanzia legale.**
